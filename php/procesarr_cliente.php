...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($data['nombre'], $data['telefono'], $data['correo'], $data['vigencia'], $data['fecha_inicio'], $data['generos'])) {
        ...
        $sql_cliente = "INSERT INTO cliente ( telefono, correo, vigencia, inicio, nombre) VALUES (?, ?, ?, ?, ?)";
        $stmt_cliente = $conexion->prepare($sql_cliente);
        $stmt_cliente->bind_param("sssss",  $telefono, $correo, $vigencia, $fechaInicio, $nombre);
        ...
        if ($stmt_cliente->execute()) {
            ...
            foreach ($generos as $idGenero) {
                ...
                $stmt_clientes_generos->bind_param("ii", $idCliente, $idGenero);
